 ...
 */
final class Version20200106142546 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE medias (id INT AUTO_INCREMENT NOT NULL, created_by_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', type enum(\'application\', \'audio\', \'chemical\', \'image\', \'message\', \'model\', \'text\', \'video\', \'unknow\'), path VARCHAR(40) NOT NULL, INDEX IDX_12D2AF81B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ads ADD CONSTRAINT FK_7EC9F620B03A8386 FOREIGN KEY (created_by_id) REFERENCES users (id) ON DELETE CASCADE');
